...
export function DataTable<TData, TValue>({ columns, data, pagination, search = '', status }: DataTableProps<TData, TValue>) {
    ...
    const handlePageChange = (page: number) => {
        ...
        navigateWithQuery('reports.index', queryParams, {
            preserveState: true,
            replace: true,
        });
    };
            ...
            <div className="flex flex-col gap-2">
                <div className="flex flex-wrap w-full gap-2 sm:flex-nowrap">
                    ...
                    <div className="relative w-full">
                        ...
                        <Input
                            placeholder="Cari nama pegawai/maksud perjalanan..."
                            value={searchValue}
                            onChange={handleSearchChange}
                            className="w-full pr-8 pl-8 md:w-[400px]"
                        />
                        {searchValue && (
                            <Button
                                variant="ghost"
                                    ...
                                    <TableHead
                                        ...
                                        className={
                                            header.id === 'actions'
                                                ...
                                                : header.id === 'no'
                                                    ? 'w-[50px]'
                                                    : header.id === 'travel_info'
                                                        ? 'w-[200px]'
                                                    : header.id === 'ppk_review'
                                                        ? 'w-[80px] text-center'
                                                    : header.id === 'pimpinan_review'
                                                        ? 'w-[100px] text-center'
                                                    : undefined
                                        }
                                    >
                                        ...
                                        <TableCell
                                            ...
                                            className={
                                                cell.column.id === 'actions'
                                                    ...
                                                    : cell.column.id === 'no'
                                                        ? 'w-[50px]'
                                                    : cell.column.id === 'travel_info'
                                                        ? 'w-[200px]'
                                                    : cell.column.id === 'ppk_review'
                                                        ? 'w-[80px] text-center'
                                                    : cell.column.id === 'pimpinan_review'
                                                        ? 'w-[100px] text-center'
                                                    : undefined
                                            }
                                        >
